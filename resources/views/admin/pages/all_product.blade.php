                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                            ...
                            <tr>
                                ...
                                <th class="wd-20p border-bottom-0">vendotr</th>
                            ...
                            @foreach($products as $index=>$item)
                                <tr>
                                    ...
                                    <td><a href="{{route('admin.get_vendor',$item->vendor->id)}}" >{{$item->vendor->name}}</a></td>
                                    <td>{{$item->price}}</td>
                                    <td>{{$item->quantity}}</td>
                                    <td>
                                        @if($item->status > 0)
...
{{--                                        <a class="btn btn-info btn-sm"--}}
{{--                                           href="{{route('vendor.product.images', $item->id)}}"><i--}}
