        ...
        <div class="">
            ...
            <div class="container-login100">
                <div class="wrap-login100 p-6">
                    <form class="login100-form validate-form" action="{{route('admin.auth.postRegister')}}"
                          method="post">
                        @csrf
                        ...
                        <div class="wrap-input100 validate-input input-group"
                            ...
                            <input class="input100 border-start-0 ms-0 form-control" name="name" value="{{old('name')}}"
                                   type="text"
                        ...
                        <div class="wrap-input100 validate-input input-group"
                            ...
                            <input class="input100 border-start-0 ms-0 form-control" name="email"
