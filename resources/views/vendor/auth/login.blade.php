                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-6">
                        @if($errors->any())
                            ...
                            @endforeach
                        @endif
                        <form action="{{route('vendor.auth.postLogin')}}" method="post" class="login100-form validate-form">
                            @csrf
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab5">
                                            <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid email is required: ex@abc.xyz">
                                                ...
                                                <input class="input100 border-start-0 form-control ms-0" name="email" value="{{old('email')}}" type="email" placeholder="Email">
                                            </div>
